...
export class JSDebugMessage extends DebugMessage {
  ...
  private constructDebuggingMsgFay(
    debuggingMsgContent: string,
    spacesBeforeMsg: string,
  ): string {
    // const wrappingMsg = `console.${extensionProperties.logType}(${extensionProperties.quote
  ...
  private constructDebuggingMsgContentFay(
    document: TextDocument,
    ...
    let finalText = MyFuncs.getLogText({
  ...
  msg(
    ...
    const debuggingMsgContent: string = ""
    ...
    //   ]),
    // );
    const debuggingMsg: string = this.constructDebuggingMsgFay(
      debuggingMsgContent,
      spacesBeforeMsg,
    );
  ...
  fayMsg(
    ...
    const selectedVar = selectedVars[selectedVars.length - 1]
    ...
    const debuggingMsgContent: string = this.constructDebuggingMsgContentFay(
      document,
      selectedVars,
      lineOfSelectedVar,
      lineOfLogMsg,
    ...
    if (
      ...
      this.jsDebugMessageAnonymous.anonymousPropDebuggingMsgFay(
        document,
        textEditor,
        tabSize,
        selectedVarLine,
